...
* **tflint:** 🐛 bump Azure rules version, fix signature bug 036d95a

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.12.2 18dbbbe
* **deps:** update dependency opentofu to v1.12.3 3c09a3e
* **deps:** update dependency opentofu to v1.12.4 a948676
* **deps:** update dependency tflint to v0.63.1 5f009b7
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 6652b61
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 9251939
...
* 🐛 default output `resource` now require sensitive with OpenTofu 1.12+ 65d8a32

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu 6ac1616
* **deps:** update dependency terraform-docs to v0.23.0 4b312db
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 f59c073
* **deps:** update tools 042c040
* **pre-commit:** 🔧 move to prek 672029c
* **tfdocs:** bump tfdocs to v0.22 🔧 b7b3d75

## 8.3.5 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ 8eef6d1

### Code Refactoring

* update module structure and Github actions 👷 cf93a34

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing f4bd625
* **deps:** 🔗 bump tflint rules version 865cab8
* **deps:** update dependency opentofu to v1.11.5 b7d5f99
* **deps:** update dependency trivy to v0.69.2 b3f1ead
* **deps:** update dependency trivy to v0.69.3 1c5807e

## 8.3.4 (2026-02-25)

### Code Refactoring

* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 f7dd2d9

### Miscellaneous Chores

* **deps:** 🔗 bump tflint rules and example 2731934
* **deps:** update dependency opentofu to v1.11.2 c5c4e69
* **deps:** update dependency opentofu to v1.11.3 788f5da
* **deps:** update dependency opentofu to v1.11.4 67e83ac
* **deps:** update dependency pre-commit to v4.5.1 db2cba3
* **deps:** update dependency tflint to v0.61.0 5653fc0
* **deps:** update dependency trivy to v0.68.2 55965dd
* **deps:** update dependency trivy to v0.69.0 03f8649
* **deps:** update dependency trivy to v0.69.1 05c417d
* **deps:** update pre-commit hook crate-ci/committed to v1.1.10 f464ed9
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 9ffff51
* **deps:** update pre-commit hook crate-ci/committed to v1.1.9 7fe52b7
* **deps:** update tools 00d3cce
...
* **deps:** 🔗 update claranet/azurecaf to ~> 1.3.0 🔧 941964e

### Miscellaneous Chores

* **deps:** update dependency trivy to v0.67.0 6f87adb

## 8.3.1 (2025-09-19)

### Styles

* 🎨 rename variable 975277d
